...
_cffi_f_corr1d_cpu_backward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 13, "corr1d_cpu_backward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr1d_cpu_forward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 11, "corr1d_cpu_forward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr1d_cuda_backward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 13, "corr1d_cuda_backward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr1d_cuda_forward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 11, "corr1d_cuda_forward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr_cpu_backward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 13, "corr_cpu_backward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr_cpu_forward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 11, "corr_cpu_forward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr_cuda_backward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 13, "corr_cuda_backward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
...
_cffi_f_corr_cuda_forward(PyObject *self, PyObject *args)
{
  ...
  aa = _cffi_unpack_args(args, 11, "corr_cuda_forward");
  if (aa == NULL)
    return NULL;
  arg0 = aa[0];
  arg1 = aa[1];
